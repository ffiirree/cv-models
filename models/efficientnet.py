...
__all__ = ['EfficientNet', 'efficientnet_b0', 'efficientnet_b0_b', 'efficientnet_b0_c', 'efficientnet_b1', 'efficientnet_b2', 'efficientnet_b3',
...
def efficientnet_b0_b(pretrained: bool = False):
    args = efficientnet_params('efficientnet-b0')
    return EfficientNetB(width_coefficient=args[0], depth_coefficient=args[1], dropout_rate=args[3])
...
def efficientnet_b0_c(pretrained: bool = False):
    args = efficientnet_params('efficientnet-b0')
    return EfficientNetC(width_coefficient=args[0], depth_coefficient=args[1], dropout_rate=args[3])
